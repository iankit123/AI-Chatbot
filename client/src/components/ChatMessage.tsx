...
import { PHOTO_GALLERY_CTA_CONTEXT } from "@/lib/photoGalleryCta";
...
export function ChatMessage({ message, botAvatar }: ChatMessageProps) {
  ...
  if (isBot && message.contextInfo === PHOTO_GALLERY_CTA_CONTEXT) {
    return (
      <div className="mb-2 flex items-end justify-start gap-2">
        ...
        <div className="min-w-0 max-w-[min(85%,20rem)] flex-1 pt-0.5">
          <PhotoGalleryCtaCard label={message.content} onClick={openPhotosTab} />
