...
export const RELATIONSHIP_PHOTO_GALLERIES: Partial<Record<string, CompanionGalleryConfig>> = {
  priya: {
    photoUrls: [
      ...
      "/images/priya-gallery/priya-photo-6.png",
      "/images/priya-gallery/priya-photo-7.jpg",
      "/images/priya-gallery/priya-photo-8.png",
      "/images/priya-gallery/priya-photo-9.png",
      "/images/priya-gallery/priya-photo-10.png",
      "/images/priya-gallery/priya-photo-11.png",
    ],
  ...
  ananya: {
    photoUrls: [
      ...
      "/images/ananya-gallery/ananya-photo-7.jpg",
      "/images/ananya-gallery/ananya-photo-8.png",
      "/images/ananya-gallery/ananya-photo-9.png",
      "/images/ananya-gallery/ananya-photo-10.png",
      "/images/ananya-gallery/ananya-photo-11.png",
    ],
  ...
  meera: {
    photoUrls: [
      ...
      "/images/meera-gallery/meera-photo-6.png",
      "/images/meera-gallery/meera-photo-7.jpg",
      "/images/meera-gallery/meera-photo-8.png",
      "/images/meera-gallery/meera-photo-9.png",
      "/images/meera-gallery/meera-photo-10.png",
      "/images/meera-gallery/meera-photo-11.png",
    ],
  ...
  naina: {
    media: [
      ...
      { src: "/images/naina-gallery/naina-photo-2.png", type: "image" },
      { src: "/images/naina-gallery/naina-photo-3.png", type: "image" },
      { src: "/images/naina-gallery/naina-photo-4.png", type: "image" },
      { src: "/images/naina-gallery/naina-photo-5.png", type: "image" },
      { src: "/images/naina-gallery/naina-photo-6.png", type: "image" },
      { src: "/images/naina-gallery/naina-photo-7.jpg", type: "image" },
      { src: "/images/naina-gallery/naina-photo-8.png", type: "image" },
      { src: "/images/naina-gallery/naina-photo-9.png", type: "image" },
      { src: "/images/naina-gallery/naina-photo-10.png", type: "image" },
      { src: "/images/naina-gallery/naina-photo-11.png", type: "image" },
    ],
